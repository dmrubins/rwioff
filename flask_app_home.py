...
import pickle
import json
from python.Schedule import Schedule, Schedules 
from python.InternSchedule import InternSchedule
from python.JuniorSchedule import JuniorSchedule
from python.SeniorSchedule import SeniorSchedule

with open("python\InternSchedules.pickle", 'rb') as f:
    intern_schedules = pickle.load(f)
with open("python\JuniorSchedules.pickle", 'rb') as f:
    junior_schedules = pickle.load(f)
with open("python\SeniorSchedules.pickle", 'rb') as f:
